defmodule App.Projects.Project do
  defstruct slug: "", draft: "", title: "", date: "", intro: "", content: "", cover: ""

  def compile(file) do
    post = %App.Projects.Project{
      slug: file_to_slug(file)
    }

    Path.join([Application.app_dir(:app, "priv/projects"), file])
    |> File.read!
    |> split
    |> extract(post)
  end
